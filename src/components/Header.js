...
const Header = () => {
    return (
        <nav id='navbar_top' className="navbar navbar-expand-lg navbar-light bg-light font-font-custom font-bold mt-10 bg-white mx-auto overflow-hidden sticky-top">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 w-100 d-flex justify-content-end">
                        ...
                        <li className="nav-item px-2">
                            <a className="nav-link" href="/" style={{ fontWeight: '900', color: 'black' }} >MARKET</a>
                        </li>
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle rounded-lg" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                                style={{
                        ...
                        <li className='nav-item nav-link mr-0 .header-connect-button' style={{
                            backgroundColor: 'rgb(34, 158, 217)', borderRadius: '7px',
                            marginLeft: '15px', color: 'white', width: '100px', marginBottom: '10px', height: '47px'
                        }}>
